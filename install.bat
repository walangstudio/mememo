...
echo try: >> "%PY_MERGE%"
echo     with open(config_path, encoding='utf-8') as f: config = json.load(f) >> "%PY_MERGE%"
...
echo with open(config_path, 'w', encoding='utf-8') as f: json.dump(config, f, indent=2); f.write('\n') >> "%PY_MERGE%"
...
echo try: >> "%PY_REMOVE%"
echo     with open(config_path, encoding='utf-8') as f: cfg = json.load(f) >> "%PY_REMOVE%"
...
echo     with open(config_path, 'w', encoding='utf-8') as f: json.dump(cfg, f, indent=2); f.write('\n') >> "%PY_REMOVE%"
...
echo     with open(config_path, encoding='utf-8') as f: config = json.load(f) >> "%PY_MERGE_VSCODE%"
...
echo     with open(config_path, encoding='utf-8') as f: cfg = json.load(f) >> "%PY_REMOVE_VSCODE%"
...
echo     with open(config_path, encoding='utf-8') as f: existing = f.read() >> "%PY_MERGE_CODEX%"
...
echo with open(config_path, 'w', encoding='utf-8') as f: f.write(existing + new_section) >> "%PY_MERGE_CODEX%"
...
echo with open(config_path, encoding='utf-8') as f: existing = f.read() >> "%PY_REMOVE_CODEX%"
...
echo     with open(config_path, 'w', encoding='utf-8') as f: f.write('\n'.join(lines)) >> "%PY_REMOVE_CODEX%"
...
echo     with open(config_path, encoding='utf-8') as f: config = json.load(f) >> "%PY_MERGE_ZED%"
...
echo     with open(config_path, encoding='utf-8') as f: cfg = json.load(f) >> "%PY_REMOVE_ZED%"
...
echo     with open(config_path, encoding='utf-8') as f: config = json.load(f) >> "%PY_MERGE_OPENCODE%"
...
echo     with open(config_path, encoding='utf-8') as f: cfg = json.load(f) >> "%PY_REMOVE_OPENCODE%"
...
echo     with open(config_path, encoding='utf-8') as f: config = yaml.safe_load(f) or {} >> "%PY_MERGE_GOOSE%"
...
echo with open(config_path, 'w', encoding='utf-8') as f: yaml.dump(config, f, default_flow_style=False, allow_unicode=True, sort_keys=False) >> "%PY_MERGE_GOOSE%"
...
echo with open(cfg_path, encoding='utf-8') as f: config = yaml.safe_load(f) or {} >> "%PY_REMOVE_GOOSE%"
echo ext = config.get('extensions', {}) >> "%PY_REMOVE_GOOSE%"
echo if 'mememo' in ext: >> "%PY_REMOVE_GOOSE%"
echo     del ext['mememo'] >> "%PY_REMOVE_GOOSE%"
echo     with open(cfg_path, 'w', encoding='utf-8') as f: yaml.dump(config, f, default_flow_style=False, allow_unicode=True, sort_keys=False) >> "%PY_REMOVE_GOOSE%"
...
echo     try: >> "%PY_STATUS%"
echo         with open(p, encoding='utf-8') as f: raw = f.read() >> "%PY_STATUS%"
echo         if fmt == 'toml': return '[mcp_servers.mememo]' in raw >> "%PY_STATUS%"
echo         if fmt == 'yaml': return '  mememo:' in raw >> "%PY_STATUS%"
echo         return 'mememo' in json.load(open(p, encoding='utf-8')).get('mcpServers', {}) >> "%PY_STATUS%"
